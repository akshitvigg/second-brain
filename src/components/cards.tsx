...
export const Card = (props: CardProps) => {
  ...
  return (
    <>
      <div className="p-4 h-auto font-poppins   border-gray-200 border shadow-md bg-white rounded-lg w-full transition duration-200 hover:scale-105 hover:shadow-lg hover:bg-gray-100">
